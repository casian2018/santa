      ...
      <div className="mx-auto mt-24 mb-24 max-w-screen-lg p-5">
        <div className="grid grid-cols-1 border md:grid-cols-12">
          <div className="bg-gray-900 p-10 text-white md:col-span-4">
            ...
            <h3 className="text-xl font-extrabold leading-normal tracking-tight sm:text-2xl">
            ...
            <div className="mt-5 flex items-center">
              <svg
                className="mr-2 h-6 text-green-600"
                fill="currentColor"
                version="1.1"
		...
		c0.067,0.04,6.778,4.003,8.521,7.296C52.202,48.062,51.994,49.447,51.078,50.363z"
              ...
              <span className="text-sm">+40 729 459 468</span>
            </div>
            <div className="mt-5 flex items-center">
              <svg
                className="mr-2 h-6 text-green-600"
          ...
          <form className="p-10 md:col-span-8">
            ...
            <div className="-mx-3 mb-6 flex flex-wrap">
              ...
              <div className="flex w-full justify-between px-3">
                ...
                <button
                  className="rounded bg-green-600 py-2 px-6 font-bold text-white shadow hover:bg-green-400 focus:shadow-outline focus:outline-none"
                  type="submit"
                >
                  Send Message
                </button>
